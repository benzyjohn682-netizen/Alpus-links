                      ...
                      <div key={item.id} className="p-6 hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-all duration-200 group">
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="relative">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
                              <img 
                                alt={item.domain} 
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="mt-4 flex flex-wrap items-center gap-4">
                              ...
                              <div className="ml-auto flex items-center space-x-4">
                                ...
                                <button
                                  onClick={() => dispatch(removeItem({ websiteId: item.websiteId, type: item.type }))}
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div className="flex space-x-2">
                          ...
                          />
                          <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                            Apply
                          </button>
                        </div>
                      </div>
                      ...
                      {/* Checkout button */}
                      <button className="w-full mt-6 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-2">
                        <CreditCard className="w-5 h-5" />
